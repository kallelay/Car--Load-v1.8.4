...
Public Class Car_Model
    ...
    Sub New(ByVal filepath As String)
        ...
        If IO.File.Exists(filepath) = False Then
            ...
            Tip.fShow("error! failed at loading model:" & filepath)
            Exit Sub
        End If
        ...
        For a = 0 To MyModel.vertnum - 1
            ...
            x = J.ReadSingle * ZoomFactor '* -1
            y = J.ReadSingle * ZoomFactor * -1
            z = J.ReadSingle * ZoomFactor '* -1
    ...
    Sub Render()
        ...
        If IO.File.Exists(Replace(Texture_, ",", ".")) Then
            ...
            tex = Car_Load.Render.VideoDriver.GetTexture(Replace(Texture_, ",", "."))

            tex.MakeColorKey(Car_Load.Render.VideoDriver, Color.Black)
        ...
        For n = 0 To Vx.VertexCount - 1
            Try
                Vx.SetIndex(n, Convert.ToUInt16(Vx.VertexCount - 1 - n))
            Catch ex As Exception
                Tip.fShow("Beyond limit of Irrlicht!")
                Exit For
            End Try
        ...
        Next
            ...
            ScnNode.SetMaterialType(MaterialType.Reflection2Layer)
            ...
            With ScnNode.GetMaterial(0)
                .Lighting = Editor.CheckBox1.Checked
                .GouraudShading = True
