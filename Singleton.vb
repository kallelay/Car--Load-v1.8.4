Public Class Singletons
    ...
    Public Sub SaveToFile(ByVal path As String)
        ...
        With _car.Theory.RealInfos
            ...
            w.WriteLine("CoM        	{0} {1} {2} 		; Centre of mass relative to model centre", .COM.X * 1 / Render.ZoomFactor, .COM.Y * 1 / Render.ZoomFactor, .COM.Z * 1 / Render.ZoomFactor)
            w.WriteLine("Weapon     	{0} {1} {2} 		; Weapon genration offset", .WeaponGeneration.X * 1 / Render.ZoomFactor, .WeaponGeneration.Y * -1 / Render.ZoomFactor, .WeaponGeneration.Z * 1 / Render.ZoomFactor)
        ...
        With _car.Theory.Body
            ...
            w.WriteLine("Offset     	{0}, {1}, {2} 		; Calculated in game", .Offset.X * 1 / Render.ZoomFactor, .Offset.Y * -1 / Render.ZoomFactor, .Offset.Z * 1 / Render.ZoomFactor)
            w.WriteLine("Mass       	{0}", .Mass)
            w.WriteLine("Inertia    	{0} {1} {2}", .Inertia(0).X * 1 / Render.ZoomFactor, .Inertia(0).Y * 1 / Render.ZoomFactor, .Inertia(0).Z * 1 / Render.ZoomFactor)
            w.WriteLine("           	{0} {1} {2}", .Inertia(1).X * 1 / Render.ZoomFactor, .Inertia(1).Y * 1 / Render.ZoomFactor, .Inertia(1).Z * 1 / Render.ZoomFactor)
            w.WriteLine("           	{0} {1} {2}", .Inertia(2).X * 1 / Render.ZoomFactor, .Inertia(2).Y * 1 / Render.ZoomFactor, .Inertia(2).Z * 1 / Render.ZoomFactor)
        ...
        For i = 0 To 3
            ...
            With _car.Theory.wheel(i)
                ...
                w.WriteLine("Offset1  	    {0} {1} {2}", .Offset(1).X * 1 / Render.ZoomFactor, .Offset(1).Y * -1 / Render.ZoomFactor, .Offset(1).Z * 1 / Render.ZoomFactor)
                w.WriteLine("Offset2  	    {0} {1} {2}", .Offset(2).X * 1 / Render.ZoomFactor, .Offset(2).Y * -1 / Render.ZoomFactor, .Offset(2).Z * 1 / Render.ZoomFactor)
        ...
        For i = 0 To 3
            ...
            With _car.Theory.Spring(i)
                ...
                w.WriteLine("Offset  	    {0} {1} {2}", .Offset.X * 1 / Render.ZoomFactor, .Offset.Y * -1 / Render.ZoomFactor, .Offset.Z * 1 / Render.ZoomFactor)
        ...
        With _car.Theory.Spinner
            ...
            w.WriteLine("ModelNum    	{0}", .modelNumber)
            w.WriteLine("Offset      	{0} {1} {2}", .offSet.X * 1 / Render.ZoomFactor, .offSet.Y * -1 / Render.ZoomFactor, .offSet.Z * 1 / Render.ZoomFactor)
            w.WriteLine("Axis        	{0} {1} {2}", .Axis.X * 1 / Render.ZoomFactor, .Axis.Y * -1 / Render.ZoomFactor, .Axis.Z * 1 / Render.ZoomFactor)
        ...
        With _car.Theory.Aerial
            ...
            w.WriteLine("Offset      	{0} {1} {2}", .offset.X * 1 / Render.ZoomFactor, .offset.Y * -1 / Render.ZoomFactor, .offset.Z * 1 / Render.ZoomFactor)
            w.WriteLine("Direction   	{0} {1} {2}", .Direction.X * 1 / Render.ZoomFactor, .Direction.Y * -1 / Render.ZoomFactor, .Direction.Z * 1 / Render.ZoomFactor)
            w.WriteLine("Length      	{0}", .length)
            w.WriteLine("Stiffness   	{0}", .stiffness)
            w.WriteLine("Damping     	{0}", .damping)
